...
\section{Interlude: Gaussian Process Regression} \label{sec:GPR}
    A Gaussian Process (GP) over $x$ is formally defined and specified by
    \begin{equation*}
    ...
    \begin{equation*}
        ...
        \end{aligned}
    \end{equation*}
    supporting the fundamental definition of the GP kernel, as a covariance over response space
    \begin{equation*}
