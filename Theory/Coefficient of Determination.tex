...
\section{Generalized Sobol' indices}\label{sec:GSI}
    ...
    \begin{equation} \label{def:GSI:variance}
        \begin{aligned}
            ...
            \covt{\,\te[\mi{L\x L^{\prime}}]{\rv{S}_{\mi{m}}}}{M} = \frac{\te[(\mi{L\x L^{\prime}})^2]{Q_{\mi{mm}}}}{\te[\mi{L}^{2}]{V_{\mi{M}}}^{2/2} \otimes \te[\mi{L^{\prime}}^{2}]{V_{\mi{M}}}^{2/2}}\\
            \te[(\mi{L\x L^{\prime}})^2]{T_{\mi{m}}^{T}} &\deq 
            \covt{\,\te[\mi{L\x L^{\prime}}]{\rv{S}_{\mi{M-m}}^{T}}}{M} \\ &\phantom{:}= 
            \frac{\te[(\mi{L\x L^{\prime}})^2]{Q_{\mi{mm}}} - 2 \te[(\mi{L\x L^{\prime}})^2]{Q_{\mi{Mm}}} + \te[(\mi{L\x L^{\prime}})^2]{Q_{\mi{MM}}}}{\te[\mi{L}^{2}]{V_{\mi{M}}}^{2/2} \otimes \te[\mi{L^{\prime}}^{2}]{V_{\mi{M}}}^{2/2}}\\
        \end{aligned}            
    \end{equation}
    where improper fractions exponentiate a square root diagonal of $V_{\mi{M}}$, and for any $\mi{m,m^{\prime}} \subseteq \mi{M}$
    \begin{multline}\label{def:GSI:Q}
        \te[\mi{L}^4]{Q_{\mi{mm^{\prime}}}} \deq \te[\mi{mm^{\prime}}]{W}
        - \te[\mi{L\x L^{\prime}}]{V_{\mi{m^{\prime}}}} \circ \sum_{\mi{L}^{\circ} \in \set{\mi{L, L^{\prime}}}} \frac{\te[\mi{L}^{\circ 2}\x\mi{L\x L^{\prime}}]{W_{\mi{Mm^{\prime}}}}} {\te[\mi{L}^{\circ 2}]{V_{\mi{M}}}^{2/2}} \\                
         + \frac{\te[\mi{L\x L^{\prime}}]{V_{\mi{m^{\prime}}}}^{2}}{4} \circ \sum_{\mi{L}^{\circ} \in \set{\mi{L, L^{\prime}}}} \frac{\te[\mi{L}^{\circ 2}\x\mi{L}^{2}]{W_{\mi{MM}}}} {\te[\mi{L}^{\circ 2}]{V_{\mi{M}}}^{2/2} \otimes \te[\mi{L}^{2}]{V_{\mi{M}}}^{2/2}}
    ...
    The remainder of this paper is devoted to calculating these two quantities -- the generalized closed Sobol' Index $S_{\mi{m}}$ and its variance over ungoverned noise (i.e. measurement uncertainty, squared) $T_{\mi{m}}$.
...
\section{Interlude: Gaussian Process regression} \label{sec:GPR}
    ...
    \subsection{Predictive GP} \label{sub:GPR:Predictive}
        ...
        \begin{equation*}
            \te[\mi{Lo\x L^{\prime\prime}o^{\prime\prime}}]{k(x,X) K_{Y}^{-1} k(X,x)} = \tte[\mi{Lo}]{K_{Y}^{-1/2} k(X,x)}^{2}
        \end{equation*}
...
\section{Complexity and simplifications}\label{sec:Complexity}
    ...
    \begin{equation*}
        ...
        l^{\prime} = l^{\prime\prime} \T{ ; } l^{\prime\prime\prime} = l  \QT{or} l = l^{\prime} 
