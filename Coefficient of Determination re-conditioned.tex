    ...
    \subsection{First Moments} \label{sub:GPMom:First}
        ...
        \begin{equation*}
            \begin{aligned}
                ...
                {\te[l\x l^{\prime}]{\Phi}}} \\
                & \phantom{\deq\ } \circ
                {\prob{\te[l\x l^{\prime}\x\mi{m\x m^{\prime\prime}}]{\Phi}\te[\mi{m^{\prime\prime}}]{z}}{\te[\mi{m}\x l\x l^{\prime}\x\mi{N^{\prime}}]{G}}
                {\te[l\x l^{\prime}]{\Gamma}\te[l\x l^{\prime}\x \mi{m^{\prime\prime}\x m}]{\Phi}}}
            \end{aligned}                    
        \end{equation*}
        and
        \begin{equation*}
            \begin{aligned}
                ...
                \te[l\x l^{\prime}\x\mi{m}\x\mi{m^{\prime\prime}}]{\Phi} &\deq 
                \te[\mi{m}\x\mi{M}]{\Theta}
                \diag[l\x l^{\prime}\x\mi{M}\x\mi{M^{\prime}}]{\Lambda^{2}+1}^{-1} \te[\mi{m^{\prime\prime}}\x\mi{M^{\prime}}]{\Theta}^{\intercal} \\
    ...
    \subsection{Second Moments} \label{sub:GPMom:Second}
        ...
        \begin{equation*}
            \begin{aligned}
                ...
                \te[l\x l^{\prime}\x \mi{m^{\prime}}\x\mi{M^{\prime}}]{\Pi}
                \te[l\x l^{\prime}\x\mi{M^{\prime}}\x\mi{m^{\prime\prime}}]{\Phi}
...
\section{Gaussian Process Estimates}\label{sec:GPEst}
    ...
    \subsection{Variance}\label{sub:GPEst:Variance}
        ...
        \begin{multline*}
            ...
            {\prob{\te[\mi{m^{\prime}}]{0}}{\te[\mi{m^{\prime}}\x l^{\prime\prime\prime}\x \mi{L^{*\prime}\x N^{*\prime}}]{\Phi G}}{\diag[\mi{m^{\prime}}^2]{1}}} \circ \right.\\
            ...
            \left. \prob{\te[\mi{m^{\prime}}\x l^{\prime\prime\prime}\x \mi{L^{*\prime}\x N^{*\prime}}]{\Phi G}}
        ...
        \begin{equation*}
            \begin{aligned}
                ...
                &\deqr \te[l^{\prime\prime}\x l^{\prime}]{1-\Upsilon}^{1/2} \te[l^{\prime\prime}\x l^{\prime}]{1-\Upsilon}^{\intercal/2} \\
                \te[l^{\prime\prime\prime}\x l^{*\prime}\x\mi{m^\prime}^{2}]{\Phi}
                &\deqr \te[l^{\prime\prime\prime}\x l^{*\prime}]{\Phi}^{1/2}                    
                \te[l^{\prime\prime\prime}\x l^{*\prime}]{\Phi}^{\intercal/2}                    
            \end{aligned}
        \end{equation*}
        and
        \begin{equation*}
            \begin{aligned}
                \te[\mi{m^{\prime}}\x l^{\prime\prime\prime}\x l^{*\prime}\x \mi{N^{*\prime}}]{\Phi G} &\deq 
                \te[l^{\prime\prime\prime}\x l^{*\prime}\x\mi{m^{\prime}}\x\mi{m^{\prime\prime\prime}}]{\Phi}^{-1/2}
                \te[\mi{m^{\prime\prime\prime}}\x l^{\prime\prime\prime}\x l^{*\prime}\x \mi{N^{*\prime}}]{G}\\
                \te[l^{\prime\prime}\x l^{\prime}\x l^{\prime\prime\prime}\x l^{*\prime}\x\mi{m^{\prime}\x m}]{\Omega} &\deq 
                \te[l^{\prime\prime\prime}\x l^{*\prime}\x\mi{m^{\prime}}\x\mi{m^{\prime\prime\prime}}]{\Phi}^{\intercal/2}
                \te[l^{\prime\prime}\x l^{\prime}\x\mi{m^{\prime\prime\prime}}\x\mi{M}]{\Pi} \\
                &\phantom{\deq\ }\te[l^{\prime\prime}\x l^{\prime}\x\mi{M}\x\mi{m^{\prime\prime}}]{\Phi}
                \te[l^{\prime\prime}\x l^{\prime}\x\mi{m^{\prime\prime}}\x\mi{m}]{\Gamma}^{-1} \\
                \te[l^{\prime\prime}\x l^{\prime}\x l^{\prime\prime\prime}\x l^{*\prime}\x\mi{m^{\prime}}^{2}]{B} &\deq 
                \te[l^{\prime\prime\prime}\x l^{*\prime}\x\mi{m^{\prime}}\x\mi{m^{*\prime}}]{\Gamma} + \\
                &\phantom{\deq\ }\te[l^{\prime\prime\prime}\x l^{*\prime}\x\mi{m^{\prime}}\x\mi{m^{*\prime\prime\prime}}]{\Phi}^{\intercal/2}
                \te[l^{\prime\prime}\x l^{\prime}\x\mi{m^{*\prime\prime\prime}}\x\mi{m^{*\prime}}]{\Pi}
                \te[l^{\prime\prime\prime}\x l^{*\prime}\x\mi{m^{*\prime}}\x\mi{m^{\prime\prime\prime}}]{\Phi}^{1/2} \\
                \te[l\x l^{\prime\prime}\x l^{*}\x l^{\prime}\x\mi{m}^{2}]{C} &\deq 
        ...
        \begin{multline*}
            ...
            {\prob{\te[\mi{m}]{0}}{\te[\mi{m}\x l\x \mi{L^{*}\x N^{*}}]{\Phi G}}{\diag[\mi{m}^2]{1}} \otimes
            \prob{\te[\mi{m^{\prime}}]{0}}{\te[\mi{m^{\prime}}\x l^{\prime\prime\prime}\x \mi{L^{*\prime\prime\prime}\x N^{*\prime\prime\prime}}]{\Phi G}}{\diag[\mi{m^{\prime}}^2]{1}}} \right.\\
            \circ \prob{\te[\mi{m}\x l\x \mi{L^{*}\x N^{*}}\x l^{\prime\prime}\x \mi{L^{*\prime\prime}}]{\Phi G}}
            {\te[\mi{m}\x l^{\prime\prime}\x \mi{L^{*\prime\prime}\x N^{*\prime\prime}}]{\Phi G}}{\te[l\x\mi{L^{*}}\x l^{\prime\prime}\x\mi{L^{*\prime\prime}}]{D}} \circ \phantom{\frac{_{\vert}^{\vert}}{}}\\
            \left. \prob{\te[\mi{m^{\prime}}\x l^{\prime}\x \mi{L^{*\prime}\x N^{*\prime}}\x l^{\prime\prime\prime}\x \mi{L^{*\prime\prime\prime}}]{\Phi G}}
            {\te[\mi{m^{\prime}}\x l^{\prime\prime\prime}\x \mi{L^{*\prime\prime\prime}\x N^{*\prime\prime\prime}}]{\Phi G}}
            {\te[l^{\prime}\x\mi{L^{*\prime}}\x l^{\prime\prime\prime}\x\mi{L^{*\prime\prime\prime}}]{D}}
            \phantom{\frac{_{\vert}^{\vert}}{_{\vert}^{\vert}}}\right\rbrack^{\dagger}
        \end{multline*}
        where
        \begin{equation*}
            \begin{aligned}
                \te[\mi{m^{\prime}}\x l^{\prime}\x \mi{L^{*\prime}\x N^{*\prime}}\x l^{\prime\prime\prime}\x \mi{L^{*\prime\prime\prime}}]{\Phi G} &\deq
                \te[l^{\prime\prime\prime}\x l^{*\prime\prime\prime}\x\mi{m^{\prime}}\x\mi{m^{\prime\prime\prime}}]{\Phi}^{-1/2}
                \te[\mi{m^{\prime\prime\prime}}\x l^{\prime}\x l^{*\prime}\x \mi{N^{*\prime}}]{G}
            \end{aligned}
        \end{equation*}
        \begin{multline*}
            \te[l^{\prime}\x l^{*\prime}\x l^{\prime\prime\prime}\x l^{*\prime\prime\prime}\x\mi{m^{\prime}}^{2}]{D} \deq \\
            \diag[\mi{m^{\prime}}^2]{1} - 
            \te[l^{\prime\prime\prime}\x l^{*\prime\prime\prime}\x\mi{m^{\prime}}\x\mi{m^{*\prime\prime\prime}}]{\Phi}^{\intercal/2}
            \te[l^{\prime}\x l^{*\prime}\x\mi{m^{*\prime\prime\prime}}\x\mi{m^{*\prime}}]{\Phi}
            \te[l^{\prime\prime\prime}\x l^{*\prime\prime\prime}\x\mi{m^{*\prime}}\x\mi{m^{\prime\prime\prime}}]{\Phi}^{1/2}
        \end{multline*}
        and similarly for $\te[\mi{m^{\prime}}\x l\x \mi{L^{*}\x N^{*}}\x l^{\prime\prime}\x \mi{L^{*\prime\prime}}]{\Phi G}, \te[l\x\mi{L^{*}}\x l^{\prime\prime}\x\mi{L^{*\prime\prime}\x m}^{2}]{D}$.


\section{Comments}\label{sec:Comments}
From \cref{eq:GPMom:Second} the terms containing $E$ reduce to squares of $g_{\mi{0}}$ by iterated expectations, and these will obviously cancel across \cref{eq:SPEst:W}. Neither the Sobol' indices nor their errors depend in any way on homoskedastic additive noise.

From \cref{eq:GPMom:Second} it is clear that
\begin{equation*}
    W_{\mi{m0}} \deq \cov[\cov{\rv{y_{0}}}{\mi{0}}]{\cov{\rv{y_{m}}}{\mi{m}}}{M} = 0
    \quad \forall \mi{m}\subseteq\mi{M}
\end{equation*}
and $W$ is of course symmetric in its subscripts. Conditional output variances are not correlated with the total output variance.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
