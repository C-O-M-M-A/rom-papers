...
\section{Gaussian Process Estimates}\label{sec:GPEst}
    ...
    Using the shorthand
    \begin{equation*}
        \te[l\x\mi{L^{\prime}}\mi{N^{\prime}}]{KY\!g_{\mi{0}}} \deq \te[l\x \mi{L^{\prime}}\mi{N^{\prime}}]{K_{Y}^{-1} Y^{\dagger}} \circ \te[l\x\mi{L^{\prime}}\x\mi{N^{\prime}}]{g_{\mi{0}}}^{\dagger}
    \end{equation*}
    to write
    \begin{equation*}                
    ...
    \subsection{Variance}\label{sub:GPEst:Variance}
        ...
        \begin{multline*}
            ...
            \prob{\te[\mi{m^{\prime}}]{0}}{\te[\mi{m^{\prime}}\x l^{\prime\prime\prime}\x \mi{L^{*\prime\prime\prime}\x N^{*\prime\prime\prime}}]{G}}{\te[l^{\prime\prime\prime}\x \mi{L^{*\prime\prime\prime}}]{\Phi}}} \circ \right.\\
